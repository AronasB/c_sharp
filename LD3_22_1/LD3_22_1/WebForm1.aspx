<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="LD3_22_1.WebForm1" %>
...
<body>
    <form id="form1" runat="server" enctype="multipart/form-data">
        <div>
            ...
            <br />
            <asp:Label ID="Label2" runat="server" Text="3 LD_22" style="text-align: center"></asp:Label>
            <br />
            <br />
            <div class="container">
                ...
                <br />
                <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Skaityti" />
                <br />
                <br />
